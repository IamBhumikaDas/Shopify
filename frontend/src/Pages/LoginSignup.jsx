...
return(
    <div className="loginsignup">
        <div className="loginsignup-container">
            ...
            {state==="Sign Up"?<p className="loginsignup-login">Already have an accoun ? <span onClick={()=>{setState("Login")}}>Login here</span></p>
            :  <p className="loginsignup-login">Create an accoun ? <span onClick={()=>{setState("Sign Up")}}>Click here</span></p>}
